...
import type { PiFaq } from "./practice-data";

type Item = PiFaq | { q: string; a: string };

export function FaqAccordion({ items, idPrefix = "faq" }: { items: readonly Item[]; idPrefix?: string }) {
