...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 lg:py-28 bg-zinc-50/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="The process"
          title="How it works"
          subtitle="A straightforward way to show value—no abstract pitch, just a link that looks like the real thing."
        />
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, i) => (
            <motion.div
              ...
              className={`relative bg-white rounded-2xl border ${step.border} p-6 shadow-sm hover:shadow-lg hover:border-zinc-200/80 transition-all`}
            >
              {/* Step number */}
