...
export default function SCHero() {
  return (
    <section className="relative min-h-[85vh] bg-slate-950 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.05)_1px,transparent_1px)] bg-[size:48px_48px]" />
      {/* Glow orbs */}
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-sky-400/8 rounded-full blur-3xl" />
      <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-teal-400/5 rounded-full blur-3xl" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 lg:pt-32 lg:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:flex lg:justify-end">
            <div className="bg-slate-900/60 backdrop-blur-sm border border-slate-800/60 rounded-2xl p-6 sm:p-8 max-w-sm w-full">
